        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 md:gap-10 lg:grid-cols-4 lg:gap-12">
          <div className="space-y-4 md:space-y-6">
            ...
            <div className="border-t border-soft-gold/20 pt-3 md:pt-4">
              <p className="text-sm text-ivory/70">
                CareSutra offers guidance-first support for insurance, loans, and health services—clear, respectful, and built for Indian
                families.
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <p className="text-sm leading-relaxed text-ivory/80">
              The fastest way to reach CareSutra is to book a guidance call or submit the appointment form—we reply with confirmed next
              steps.
            </p>
